...
- Sometimes the IDE can be a bit dodgy and cause the build and tests to fail or swagger to cause a 500 error. Please just click to rerun button or retest as this will solve the issue - I have attached the webPhotos folder to prove the application works, I've also tested a seperate download of this project with a seperate database location to verify everything still works
